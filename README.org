...
variable on both sides. =sbcl-worker-name-p= checks the accepted one-to-eighty
character worker-name syntax before an application constructs its own diagnostic.
